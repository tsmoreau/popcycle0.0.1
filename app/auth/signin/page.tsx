      ...
      <div className="w-full max-w-md">
        ...
        <Card className="bg-white border-4 border-pop-black shadow-2xl">
          ...
          <CardContent className="space-y-6">
            {/* Google SSO - Test Mode */}
            {providers?.google && (
              <div className="bg-yellow-50 border-2 border-yellow-400 p-4 mb-4">
                <h3 className="systematic-caps text-sm text-yellow-700 mb-2">🧪 Google SSO (Test Mode)</h3>
                <p className="text-xs text-yellow-600 mb-3">Your email must be in the Google OAuth test user list</p>
                <Button
                  onClick={() => {
                ...
                <div className="text-center text-xs systematic-caps text-gray-500 mt-2">
                  If error persists, use magic link below
                </div>
              </div>
            )}
