...
export default function TrackItem() {
  ...
  const isProcessed = !!item.processedDate || (item.id.startsWith("T") && item.event === "inventory_creation");
        ...
        <div className="mb-12">
          <div className="flex gap-4 justify-center max-w-3xl mx-auto">
            ...
            <div className="text-center flex-1 max-w-[140px]">
              ...
              <p className="text-xs text-pop-gray">
                {item.id === "TKIZI86K" || (item.id.startsWith("T") && item.event === "inventory_creation")
                  ? "Complete"
