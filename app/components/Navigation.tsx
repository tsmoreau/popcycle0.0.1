              ...
              {aboutOpen && (
                <div className="fixed left-0 right-0 top-[88px] z-50 bg-white border-t border-gray-200 shadow-lg">
                  <div className="max-w-7xl mx-auto px-12 py-8">
                    <div style={{ columnWidth: '180px', columnGap: '1.5rem', columnFill: 'auto', maxHeight: '400px' }}>
                      ...
                      <div className="aspect-[3/4] w-64 bg-gray-100 relative group cursor-pointer overflow-hidden mb-6 break-inside-avoid inline-block mr-6">
