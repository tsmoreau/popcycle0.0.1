    ...
    return (
      <div className="relative" ref={dropdownRef}>
        ...
        <Button
          ...
          variant="outline"
          className="flex items-center space-x-2 border border-gray-300 hover:bg-pop-green systematic-caps"
        >
          <div className="w-6 h-6 bg-pop-green border border-gray-300 rounded-full flex items-center justify-center">
  ...
  return (
    <>
      <button
        ...
        className="w-8 h-8 rounded-full bg-white border-pop-gray flex items-center justify-center hover:opacity-80 transition-opacity"
        data-testid="button-signin"
      >
        <User className="w-6 h-6 text-pop-gray" />
      </button>
