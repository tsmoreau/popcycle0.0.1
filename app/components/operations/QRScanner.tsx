...
export const QRScanner = ({ open, onOpenChange }: QRScannerProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-screen h-screen max-w-none m-0 rounded-none md:w-auto md:h-auto md:max-w-lg md:max-h-[80vh] md:m-6 md:rounded-lg overflow-y-auto">
