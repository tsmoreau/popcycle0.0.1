      ...
      <Dialog open={isLogisticsFullscreen} onOpenChange={setIsLogisticsFullscreen}>
        <DialogContent className="max-w-none w-screen h-screen m-0 p-0 bg-gray-50">
          <div className="flex flex-col h-full">
            <div className="flex items-center justify-end p-6 bg-white border-b">
              <Button
                variant="outline"
                size="sm"
            ...
            <div className="flex-1 flex flex-col h-full overflow-hidden">
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full h-full flex flex-col">
                ...
                <TabsContent value="collections" className="flex-1 px-6 pb-6 overflow-hidden">
                  <CollectionsTab
                    bins={bins}
                    loadingBins={loadingBins}
                    allBinColumns={allBinColumns}
                ...
                <TabsContent value="processing" className="flex-1 px-6 pb-6 overflow-hidden">
                  <ProcessingTab
                    batches={batches}
                    loadingBatches={loadingBatches}
                    allBatchColumns={allBatchColumns}
                ...
                <TabsContent value="fulfillment" className="flex-1 px-6 pb-6 overflow-hidden">
                  <FulfillmentTab
                    orders={orders}
                    loadingOrders={loadingOrders}
                    allOrderColumns={allOrderColumns}
                ...
                <TabsContent value="inventory" className="flex-1 px-6 pb-6 overflow-hidden">
                  <InventoryTab
                    blanks={blanks}
                    loadingBlanks={loadingBlanks}
                    allBlankColumns={allBlankColumns}
