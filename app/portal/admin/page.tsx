...
export default function AdminPage() {
  ...
  const stationsData: Station[] = [
    {
      ...
      type: "Weighing/Photo",
      status: "Online",
      description: "HID Scale + Camera Ready",
    },
    {
      id: "ST-002",
      name: "Station 2",
      ...
      status: "Active",
      description: "Lightburn Integration",
    },
  ];
  ...
  const userColumns: Column<User>[] = [
    ...
    },
    {
      ...
      header: "Partner Org",
      render: (user) =>
        user.orgId ? <Badge variant="outline">{user.orgId}</Badge> : "-",
    },
  ...
  const renderUserModal = (user: User) => (
    <div>
      ...
      <div className="space-y-3">
        ...
        <div>
          <strong>Partner Org:</strong> {user.orgId || "None"}
        </div>
        <div>
        ...
        <div className="pt-4 space-y-2">
          ...
          <Button variant="outline" className="w-full text-pop-red">
            Deactivate User
          </Button>
        </div>
      </div>
          ...
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <h3 className="text-lg font-semibold text-pop-black">
                  Admin Overview
                </h3>
              </div>
            </div>
          ...
          <AccordionContent>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-2 pb-4">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-pop-black mb-1">
                  2,847
                </div>
      ...
      <div className="space-y-3">
        ...
        <div className="w-full border rounded-lg">
          <div
            ...
            onClick={() => setShowProductionStations(!showProductionStations)}
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Database className="h-5 w-5 text-pop-green" />
                <span className="text-lg font-semibold">Production Stations</span>
              </div>
              <ChevronDown
                className={`h-5 w-5 text-gray-400 transition-transform ${showProductionStations ? "rotate-180" : ""}`}
              />
            </div>
          </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg font-semibold">QR Code Generation Settings</span>
              </div>
              <ChevronDown
                className={`h-5 w-5 text-gray-400 transition-transform ${showQRSettings ? "rotate-180" : ""}`}
              />
            </div>
          </div>
          {showQRSettings && (
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg font-semibold">External Integrations</span>
              </div>
              <ChevronDown
                className={`h-5 w-5 text-gray-400 transition-transform ${showIntegrations ? "rotate-180" : ""}`}
              />
            </div>
          </div>
          {showIntegrations && (
              ...
              <div className="space-y-2 mt-4">
                <div className="flex items-center justify-between p-3 bg-white rounded-lg border">
                  <div>
                    ...
                    <p className="text-xs text-gray-600">
                      Email automation & calendar sync
                    </p>
                  </div>
        ...
        <div className="w-full border rounded-lg">
          <div
            className="px-4 py-4 cursor-pointer hover:bg-gray-50"
            onClick={() => setShowBackupRecovery(!showBackupRecovery)}
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Shield className="h-5 w-5 text-pop-green" />
                <span className="text-lg font-semibold">Data Backup & Recovery</span>
              </div>
              <ChevronDown
                className={`h-5 w-5 text-gray-400 transition-transform ${showBackupRecovery ? "rotate-180" : ""}`}
              />
            </div>
          </div>
          {showBackupRecovery && (
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg font-semibold">System Audit Trail</span>
              </div>
              <ChevronDown
            ...
            <div className="px-4 pb-4 border-t bg-gray-50">
              <div className="space-y-2 mt-4">
                <div className="p-3 bg-white rounded-lg border">
                  ...
                  <p className="text-xs text-gray-600">
                    Sarah Chen logged into admin portal
                  </p>
                </div>
                <div className="p-3 bg-white rounded-lg border">
                  <div className="flex justify-between items-start mb-2">
                  ...
                  <p className="text-xs text-gray-600">
                    QR code settings updated by Mike Rodriguez
                  </p>
                </div>
                <div className="p-3 bg-white rounded-lg border">
                  <div className="flex justify-between items-start mb-2">
                  ...
                  <p className="text-xs text-gray-600">
                    User data exported for partner report
                  </p>
                </div>
              </div>
              <div className="mt-4 space-y-2">
